    ...
    <>
      <div className="text-center w-full">
        ...
        <p className="text-lg mt-4">
          I am pursuing my graduation in Computer Science and Engineering from
          VIT Vellore.
        </p>
        ...
        <div className="gap-3">
          ...
          <div className="border-2 border-blue-500 text-white py-2 px-4 m-2 w-auto rounded">
          ...
          <div className="border-2 border-blue-500 text-white py-2 px-4 m-2 w-auto rounded">
            Other Tools and Technologies: Redux, Figma, Next.js, Google OAuth
            API, Postman, Go
          </div>
          <div className="border-2 border-blue-500 text-white py-2 px-4 m-2 w-auto rounded">
